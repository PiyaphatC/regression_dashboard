...
DEFAULT_FEATURES = [
    ...
    "sidewalk_length_surface_neg1", "barrier_pct_neg1",
    "sidewalk_length_surface_0",    "barrier_pct_0",
    "sidewalk_length_surface_1",    "barrier_pct_1",
    "sidewalk_length_shade_neg1",   "shade_pct_neg1",
    "sidewalk_length_shade_0",      "shade_pct_0",
    "sidewalk_length_shade_1",      "shade_pct_1",
    "sidewalk_length_obstacle_neg1","obs_pct_neg1",
    "sidewalk_length_obstacle_0",   "obs_pct_0",
    "sidewalk_length_obstacle_1",   "obs_pct_1",
